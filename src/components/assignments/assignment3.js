    ...
    return (
      <div>
        ...
        <p style={{ margin: "50px", textAlign: "left", fontSize: "20px" }}>
          ...
          is, every time I hover over a country on a map visualization. NO. This
        ...
        <p style={{ margin: "50px", textAlign: "left", fontSize: "20px" }}>
          ...
          the horoscope API provided on the class webiste. The only pizazz I
        ...
        <p style={{ margin: "50px", textAlign: "left", fontSize: "20px" }}>
          ...
          correct url to render the moving gif took a bit since I never used it
          ...
          fix. This wasn't a me problem, more of a problem acecessing their API.
          I brought the issue into class, but we never resolved it.
        </p>
        <form
          onSubmit={e => {
            e.preventDefault();
